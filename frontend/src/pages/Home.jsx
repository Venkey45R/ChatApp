...
function Home() {
  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-background">
      ...
      <div className="bg-component-bg rounded-2xl shadow-2xl w-full max-w-full h-[calc(100vh-4rem)] mt-16 overflow-hidden flex transform transition-all duration-300 ease-in-out">
        <SideBar />
