...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-2 bg-gray-background text-text-primary">
      <div className="w-full max-w-md p-8 border shadow-2xl bg-component-bg border-soft-teal/30 rounded-2xl animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="relative">
            ...
            <div className="absolute inset-y-0 flex items-center pt-8 pointer-events-none left-3 ">
          ...
          <button
            ...
            className="w-full h-12 mt-4 font-semibold custom bg-soft-teal text-deep-ocean-blue rounded-lg hover:bg-soft-teal/90 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center shadow-lg transform hover:scale-[1.01] duration-200"
          >
            {isLoggingIn ? (
        ...
        <div className="my-6 text-center">
          <p className="text-text-muted">
            ...
            <Link
              to="/signup"
              className="font-medium transition-colors duration-200 button text-muted-gold hover:underline hover:text-muted-gold/80"
            >
              Sign up
            </Link>
          </p>
